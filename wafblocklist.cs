...
public static class ProcessIPBlocklistAndUpdateFrontDoorWaf
{
    ...
    private static async Task UpdateFrontDoorWafPolicy(List<string> ips, ILogger logger)
    {
        ...
        var requestUri = $"https://management.azure.com/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/providers/Microsoft.Network/frontdoorwebapplicationfirewallpolicies/{policyName}?api-version=2023-05-01";
